...
const AntofagastaDeLaSierraDetails = memo(() => {
  const locations = [
    {
    ...
    {
      imgSrc: "img/Antofagasta-de-la-Sierra/Salar de Antofalla.webp",
    ...
    {
      imgSrc: "img/Antofagasta-de-la-Sierra/Museo del Hombre.webp",
