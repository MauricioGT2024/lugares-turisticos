import './CatamarcaDetails.css' // O ajusta la ruta según tu estructura
  ...
  return (
    ...
    <div className="catamarca" id="catamarca">
      ...
      <div className="catamarca" id="catamarca">
        ...
        />
        <div className="catamarca-content">
          <h2 className="catamarca-title"> Dique El Jumeal</h2>
          <p className="catamarca-description">
      ...
      <div className="catamarca" id="catamarca">
        ...
        />
        <div className="catamarca-content">
          <h2 className="catamarca-title">Parque Adán Quiroga</h2>
          <p className="catamarca-description">
      ...
      <div className="catamarca" id="catamarca">
        ...
        />
        <div className="catamarca-content">
          <h2 className="catamarca-title">Parque de los Vientos</h2>
          <p className="catamarca-description">
      ...
      <div className="catamarca" id="catamarca">
        ...
        />
        <div className="catamarca-content">
          <h2 className="catamarca-title">Dique Las Pirquitas</h2>
          <p className="catamarca-description">
      ...
      <div className="catamarca" id="catamarca">
        ...
        />
        <div className="catamarca-content">
          <h2 className="catamarca-title">El Rodeo</h2>
          <p className="catamarca-description">
